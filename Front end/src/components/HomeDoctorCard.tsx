 ...
 * HomeDoctorCard.tsx
 * 
 * Role: Simplified Doctor Card for Homepage
 * Responsibilities:
 * - Displays a condensed version of doctor information suitable for the homepage carousel or grid.
 * - Shows doctor's image, name, specialty, rating, and a brief description.
 * - Focuses on visual appeal and quick scanning rather than detailed actions.
 */
...
interface HomeDoctorCardProps {
    doctor: Doctor;
    // Optional callbacks for interactivity, though primarily display-only
    onBook?: (doctor: Doctor) => void;
    onViewProfile?: (doctor: Doctor) => void;
}

export const HomeDoctorCard: React.FC<HomeDoctorCardProps> = ({ doctor }) => {
    ...
    return (
        ...
        >
            ...
            <div className="px-2 flex-1 flex flex-col">
                ...
                <p className="text-gray-500 text-sm leading-relaxed line-clamp-3 mb-2">
                    {doctor.description || 'Experienced specialist dedicated to providing top-quality patient care.'}
                </p>
            </div>
        </div>
    );
